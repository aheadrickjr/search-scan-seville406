...
MOCK_ROWS = [
    ...
    #  booking_lang, booking_status, manual_review, notes)
    (
        ...
        "Active PIR listing", "Medium", True, True, False,
    ...
    (
        ...
        "Dead PIR page", "High", False, False, False,
    ...
    (
        ...
        "Redirect to PIR inventory", "Medium", False, False, False,
        False, "No booking path detected", True,
    ...
    (
        ...
        "Redirect to unrelated property", "Medium", False, False, False,
        False, "No booking path detected", True,
    ...
    (
        ...
        "Franke Rentals listing", "High", True, False, True,
        False, "No booking path detected", False,
        "",
    ),
    (
        ...
        "Active third-party listing attributed to PIR", "High", True, True, False,
    ...
    (
        ...
        [], False, False, True,
        "Apparently bookable listing", "Medium", True, False, False,
    ...
    (
        ...
        "OTA page, no availability signal detected", "Medium", True, False, False,
    ...
    (
        ...
        [], False, False, False,
        "Blocked or inaccessible", "Low", False, False, False,
    ...
    (
        ...
        "Search result only (no page content confirms property)", "Low", True, True, False,
        False, "Unable to determine (content check skipped per robots.txt)", True,
        "",
    ),
    (
        ...
        "Unclear — manual review required", "Low", False, False, False,
        False, "No booking path detected", True,
        "",
    ),
    (
        ...
        "Duplicate", "Medium", True, True, False,
        True, "Booking controls detected", False,
